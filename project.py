...
app = Flask(__name__)
json_secrets = json.loads(open('client_secrets.json', 'r').read())
...
# JSON for all menu items by restaurant
...
# JSON for menu item by restaurant and item id
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        return ("<script>function myFunction() {alert('You are not "
                ...
                " own restaurant in order to delete.');}"
...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return ("<script>function myFunction() {alert('You are not "
                "authorized to delete menu items to this restaurant. Please"
                " create your own restaurant in order to delete items.');}"
                "</script><body onload='myFunction()''>")
    if request.method == 'POST':
